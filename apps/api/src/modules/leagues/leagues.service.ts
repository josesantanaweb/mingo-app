...
import type { CreateLeagueInput, UpdateLeagueInput } from '@/modules/leagues/dto/league.input';
...
export class LeaguesService {
   ...
   */
  async create(input: CreateLeagueInput): Promise<League> {
   ...
   */
  async update(id: string, input: UpdateLeagueInput): Promise<League> {
